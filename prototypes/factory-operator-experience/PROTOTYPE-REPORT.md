...
- El resultado `validated` conserva ese walkthrough A1–A5; esta corrección cambió el fixture y no se repitió el navegador en esta sesión, por lo que el walkthrough debe repetirse tras el cambio.
